...
@endphp
	<head>
		...
		<meta name="description" content="{{ $page->meta_description != '' ? $page->meta_description : 'work from JK Keller' }}">
		...
		<meta itemprop="description" content="{{ $page->meta_description != '' ? $page->meta_description : 'work from JK Keller' }}">
		...
		<meta name="twitter:description" content="{{ $page->meta_description != '' ? $page->meta_description : 'work from JK Keller' }}">
		{{-- <meta name="twitter:site" content="@anonlethal_jerk"> --}}
		{{-- <meta name="twitter:creator" content="@anonlethal_jerk"> --}}
		<meta name="twitter:image" content="{{ $page->twitter_image != '' ? $page->twitter_image : 'https://jk-keller.com/x__x/jk_keller-home-twitter-1024x512.png' }}">
		...
		<meta name="og:description" content="{{ $page->meta_description != '' ? $page->meta_description : 'work from JK Keller' }}">
