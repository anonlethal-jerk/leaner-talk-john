@php
	...
	$t_meta_description = 'Bot character made from altered '.$page->title.' packaging';
	$page->twitter_image = 'https://jk-keller.com/o__o/boxbots/x__x/'.$toggleCurrent.'-large/'.$page->imgfile.'.png'; // hmmm... 1024x512
	$page->open_graph_image = 'https://jk-keller.com/o__o/boxbots/x__x/'.$toggleCurrent.'-large/'.$page->imgfile.'.png'; // hmmm... 1200x630
@endphp
